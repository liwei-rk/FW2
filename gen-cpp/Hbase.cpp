        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype368, _vtype369, _size367);
            uint32_t _i371;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype384, _vtype385, _size383);
            uint32_t _i387;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype420, _vtype421, _size419);
            uint32_t _i423;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype429, _vtype430, _size428);
            uint32_t _i432;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype454, _vtype455, _size453);
            uint32_t _i457;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype516, _vtype517, _size515);
            uint32_t _i519;
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype532, _vtype533, _size531);
            uint32_t _i535;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            iprot->readListBegin(_etype545, _size542);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            iprot->readListBegin(_etype556, _size553);
